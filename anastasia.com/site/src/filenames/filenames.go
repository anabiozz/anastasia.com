...
var (
	...
	ContentFilepath  = filepath.Join(AssetPath, "app")
	...
	StylesFilePath   = filepath.Join(ContentFilepath, "stylesheets")
	JsFilePath       = filepath.Join(ContentFilepath, "js")
	FontsFilePath    = filepath.Join(ContentFilepath, "fonts")
...
func createDirectories() error {
	paths := []string{DatabaseFilepath, ThemesFilepath,
		HttpsFilepath, PluginsFilepath, PagesFilepath}
